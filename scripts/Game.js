Game = function(game){
	this.bg = null;
	this.timeCreated = 0;
	this.textScore = null; //usar para el score
...
Game.prototype = {
	create:function(){
		...
		this.textTiempo = this.add.text(Global.WIDTH - 60,0,'0',this.fontStyle);
		this.textCombo = this.add.text(0,0,'Combo: x' + this.combo ,this.fontStyle);
